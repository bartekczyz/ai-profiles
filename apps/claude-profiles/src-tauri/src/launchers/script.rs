...
pub fn launcher_script(profile_id: &str, spec: &AppSpec) -> String {
    let profiles_base = "$HOME/Library/Application Support/claude-profiles/profiles";
...
mod tests {
    ...
    fn codex_script_exports_config_home_at_profile_cli_config() {
        ...
        assert!(script.contains(
            "CONFIG_DIR=\"$HOME/Library/Application Support/claude-profiles/profiles/abc/cli-config\""
        ));
